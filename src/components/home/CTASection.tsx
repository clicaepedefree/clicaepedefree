      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-2xl mx-auto">
            Junte-se aos restaurantes que já estão vendendo mais com nosso cardápio digital. 
            Comece hoje mesmo, é rápido e totalmente gratuito!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-primary-glow mb-2">1K+</div>
              <div className="text-white/80">Restaurantes ativos</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary-glow mb-2">50K+</div>
              <div className="text-white/80">Pedidos processados</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary-glow mb-2">4.9★</div>
