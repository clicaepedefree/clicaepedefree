      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-6 py-3 mb-8 border border-white/20">
            ...
            <span className="font-medium">🚀 Comece agora mesmo - 100% gratuito</span>
          </div>

          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Transforme suas vendas digitalmente
          </h2>
          
          <p className="text-xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
            Junte-se a milhares de restaurantes que já aumentaram suas vendas com nosso cardápio digital. 
            <strong className="text-white"> Zero custos, zero comissões, resultados reais.</strong>
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-10">
            <Button variant="default" size="lg" className="text-lg px-10 py-6 bg-white text-blue-600 hover:bg-gray-50 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300" asChild>
              <Link to="/criar-conta">
          ...
          <div className="grid sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-white/80 text-sm">Gratuito para sempre</div>
            </div>
            <div className="text-center">
