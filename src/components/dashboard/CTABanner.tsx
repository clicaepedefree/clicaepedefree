        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-foreground mb-2">
              Quer conhecer o nosso sistema completo?
            </h3>
            <p className="text-muted-foreground mb-4">
              Com robô de WhatsApp, controle de estoque, PDV, atendimento de mesas e controle financeiro. 
              Conheça todas as funcionalidades avançadas!
            </p>
